...
namespace WitchCityRope.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250706152327_CompleteIdentitySetup")]
    partial class CompleteIdentitySetup
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WitchCityRope.Infrastructure.Identity.WitchCityRopeRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 6, 15, 23, 27, 447, DateTimeKind.Utc).AddTicks(3352),
                            Description = "Standard event attendee",
                            IsActive = true,
                            Name = "Attendee",
                            NormalizedName = "ATTENDEE",
                            Priority = 0,
                            UpdatedAt = new DateTime(2025, 7, 6, 15, 23, 27, 447, DateTimeKind.Utc).AddTicks(3538)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 7, 6, 15, 23, 27, 447, DateTimeKind.Utc).AddTicks(4208),
                            Description = "Verified community member with additional privileges",
                            IsActive = true,
                            Name = "Member",
                            NormalizedName = "MEMBER",
                            Priority = 1,
                            UpdatedAt = new DateTime(2025, 7, 6, 15, 23, 27, 447, DateTimeKind.Utc).AddTicks(4209)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 7, 6, 15, 23, 27, 447, DateTimeKind.Utc).AddTicks(4221),
                            Description = "Event organizer who can create and manage events",
                            IsActive = true,
                            Name = "Organizer",
                            NormalizedName = "ORGANIZER",
                            Priority = 2,
                            UpdatedAt = new DateTime(2025, 7, 6, 15, 23, 27, 447, DateTimeKind.Utc).AddTicks(4221)
                        },
                        new
                        {
                            Id = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTime(2025, 7, 6, 15, 23, 27, 447, DateTimeKind.Utc).AddTicks(4228),
                            Description = "Community moderator who can review incidents and vetting",
                            IsActive = true,
                            Name = "Moderator",
                            NormalizedName = "MODERATOR",
                            Priority = 3,
                            UpdatedAt = new DateTime(2025, 7, 6, 15, 23, 27, 447, DateTimeKind.Utc).AddTicks(4228)
                        },
                        new
                        {
                            Id = new Guid("55555555-5555-5555-5555-555555555555"),
                            CreatedAt = new DateTime(2025, 7, 6, 15, 23, 27, 447, DateTimeKind.Utc).AddTicks(4234),
                            Description = "System administrator with full access",
                            IsActive = true,
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR",
                            Priority = 4,
                            UpdatedAt = new DateTime(2025, 7, 6, 15, 23, 27, 447, DateTimeKind.Utc).AddTicks(4234)
                        });
                });
