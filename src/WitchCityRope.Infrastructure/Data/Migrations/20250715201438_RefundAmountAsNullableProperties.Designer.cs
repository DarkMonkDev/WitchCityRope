...
namespace WitchCityRope.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250715201438_RefundAmountAsNullableProperties")]
    partial class RefundAmountAsNullableProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WitchCityRope.Core.Entities.ContentPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 7, 12, 0, 0, 0, DateTimeKind.Utc),
                            HasBeenEdited = false,
                            LastModifiedBy = "system",
                            Slug = "resources",
                            Title = "Resources",
                            UpdatedAt = new DateTime(2025, 7, 7, 12, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("WitchCityRope.Core.Entities.Event", b =>
                {
                    ...
                    b.Property<decimal?>("CouplesPrice")
                        .HasPrecision(18, 2)
                    ...
                    b.Property<bool>("RequiresVetting")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("WitchCityRope.Core.Entities.EventEmailTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WitchCityRope.Core.Entities.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WitchCityRope.Core.Entities.UserNote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WitchCityRope.Core.Entities.VolunteerAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WitchCityRope.Core.Entities.VolunteerTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WitchCityRope.Core.Entities.Payment", b =>
                {
                    b.HasOne("WitchCityRope.Core.Entities.Ticket", "Ticket")
                        .WithOne("Payment")
                        .HasForeignKey("WitchCityRope.Core.Entities.Payment", "TicketId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("WitchCityRope.Core.Entities.VolunteerAssignment", b =>
                {
                    b.HasOne("WitchCityRope.Core.Entities.VolunteerTask", "Task")
