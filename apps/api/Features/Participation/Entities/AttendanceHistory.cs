...
/// <summary>
/// AttendanceHistory entity - Comprehensive audit trail for attendance changes
...
public class AttendanceHistory
{
    ...
    public EventAttendance Attendance { get; set; } = null!;
    ...
    /// </summary>
    public AttendanceHistory(Guid attendanceId, string actionType) : this()
    {
