        ...
        try
        {
            ...
            var eventDtos = events.Select(e =>
            {
                ...
                return new EventDto
                {
                    ...
                    AvailableSpotsDisplay = e.GetAvailableSpotsDisplay(),
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            var eventDto = new EventDto
            {
                ...
                AvailableSpotsDisplay = eventEntity.GetAvailableSpotsDisplay(),
        ...
        try
        {
            ...
            try
            {
                ...
                var eventDto = new EventDto
                {
                    ...
                    AvailableSpotsDisplay = copiedEventWithNav.GetAvailableSpotsDisplay(),
        ...
        try
        {
            ...
            try
            {
                ...
                var eventDto = new EventDto
                {
                    ...
                    AvailableSpotsDisplay = createdEventWithNav.GetAvailableSpotsDisplay(),
