...
namespace WitchCityRope.Api.Migrations
{
    ...
    [Migration("20260516062807_AddAuthNetRefundTransactionIdToPaymentRefund")]
    partial class AddAuthNetRefundTransactionIdToPaymentRefund
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketTypeSessions", b =>
                {
                    ...
                    b.ToTable("TicketTypeSessions", (string)null);
                });
            ...
            modelBuilder.Entity("WitchCityRope.Api.Features.Authentication.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WitchCityRope.Api.Features.CheckIn.Entities.CheckInSessionTokenSession", b =>
                {
                    ...
                    b.ToTable("CheckInSessionTokenSessions", "public");
                });
            ...
            modelBuilder.Entity("WitchCityRope.Api.Features.EmailTemplates.Entities.EventEmailTemplate", b =>
                {
                    ...
                    b.Property<bool?>("OverrideSendingEnabled")
                        .HasColumnType("boolean");

                    b.Property<int?>("OverrideTimingOffsetDays")
                        .HasColumnType("integer");

                    b.Property<int?>("OverrideTimingOffsetHours")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("EventEmailTemplates", "public", t =>
                        {
                            ...
                            t.HasCheckConstraint("CHK_EventEmailTemplates_OverrideTimingOffsetHours", "\"OverrideTimingOffsetHours\" IS NULL OR (\"OverrideTimingOffsetHours\" >= -23 AND \"OverrideTimingOffsetHours\" <= 23)");
            ...
            modelBuilder.Entity("WitchCityRope.Api.Features.EmailTemplates.Entities.GlobalEmailTemplate", b =>
                {
                    ...
                    b.HasIndex("TriggerType", "SendingEnabled")
                    ...
                    b.ToTable("GlobalEmailTemplates", "public", t =>
                        {
                            ...
                            t.HasCheckConstraint("CHK_GlobalEmailTemplates_RecipientGroup", "\"RecipientGroup\" IS NULL OR \"RecipientGroup\" IN (0, 1, 2, 3, 4)");
                            ...
                            t.HasCheckConstraint("CHK_GlobalEmailTemplates_TimingOffsetHours", "\"TimingOffsetHours\" IS NULL OR (\"TimingOffsetHours\" >= -23 AND \"TimingOffsetHours\" <= 23)");
            ...
            modelBuilder.Entity("WitchCityRope.Api.Features.Logging.Entities.ApplicationLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("Properties"), new[] { "jsonb_path_ops" });
                    ...
                    b.HasIndex("Timestamp", "SourceContext")
                        .HasDatabaseName("IX_application_logs_recent_errors")
                        .HasFilter("level >= 3");

                    b.ToTable("application_logs", "logging");
                });

            modelBuilder.Entity("WitchCityRope.Api.Features.Logging.Entities.DailyLogSummary", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("Date", "Category", "Subcategory")
                        .IsUnique()
                        .HasDatabaseName("UQ_daily_log_summaries_date_category_subcategory");

                    b.ToTable("daily_log_summaries", "logging");
                });
            ...
            modelBuilder.Entity("WitchCityRope.Api.Features.Participation.Entities.AttendanceHistory", b =>
                {
                    ...
                    b.ToTable("AttendanceHistory", "public", t =>
                        {
                            t.HasCheckConstraint("CHK_AttendanceHistory_ActionType", "\"ActionType\" IN ('Created', 'Updated', 'Cancelled', 'Refunded', 'StatusChanged', 'PaymentUpdated', 'TicketAssigned', 'TicketReassigned', 'TicketAccepted', 'TicketDeclined', 'ProxyRSVPCreated', 'ProxyRSVPAccepted', 'ProxyRSVPDeclined', 'ReminderSent')");
                        });
                });

            modelBuilder.Entity("WitchCityRope.Api.Features.Participation.Entities.AuthorizedContact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DelegateId", "RevokedAt")
                        .HasDatabaseName("IX_AuthorizedContacts_DelegateId_RevokedAt");

                    b.HasIndex("PrincipalId", "DelegateId")
                        .IsUnique()
                        .HasDatabaseName("UQ_AuthorizedContacts_Principal_Delegate_Active")
                        .HasFilter("\"RevokedAt\" IS NULL");

                    b.ToTable("AuthorizedContacts", "public", t =>
                        {
                            t.HasCheckConstraint("CHK_AuthorizedContacts_NoSelfAuthorization", "\"PrincipalId\" != \"DelegateId\"");
                        });
                });
            ...
            modelBuilder.Entity("WitchCityRope.Api.Features.Participation.Entities.EventAttendance", b =>
                {
                    ...
                    b.HasIndex("UserId", "EventId", "AttendanceType", "SessionId")
                        .IsUnique()
                        .HasDatabaseName("UQ_EventAttendances_User_Event_Type_Session_Active")
                        .HasFilter("\"Status\" IN (1, 6)");
                    ...
                    b.ToTable("EventAttendances", "public", t =>
                        {
                            ...
                            t.HasCheckConstraint("CHK_EventAttendances_Status", "\"Status\" IN (1, 2, 3, 4, 5, 6)");
                        });
                });
            ...
            modelBuilder.Entity("WitchCityRope.Api.Features.Payments.Entities.PaymentRefund", b =>
                {
                    ...
                    b.Property<string>("EncryptedAuthNetRefundTransactionId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("WitchCityRope.Api.Models.Event", b =>
                {
                    ...
                    b.Property<int?>("DefaultMaxTicketOrRsvpPerPerson")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("RequireTicketPurchase")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
                    ...
                    b.Property<bool>("VettedMembersOnly")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("WitchCityRope.Api.Models.TicketPurchase", b =>
                {
                    ...
                    b.Property<string>("EncryptedAuthNetTransactionId")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<string>("PayPalOrderIdHash")
                        .HasMaxLength(64)
                    ...
                    b.Property<Guid?>("PurchasedForUserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WitchCityRope.Api.Models.TicketType", b =>
                {
                    ...
                    b.ToTable("TicketTypes", "public", t =>
                        {
                            t.HasCheckConstraint("CHK_TicketTypes_MaxQuantityPerPurchase", "\"MaxQuantityPerPurchase\" >= 1 AND \"MaxQuantityPerPurchase\" <= 10");
                        });
                });
            ...
            modelBuilder.Entity("WitchCityRope.Api.Features.CheckIn.Entities.CheckInSessionTokenSession", b =>
                {
                    ...
                    b.HasOne("WitchCityRope.Api.Features.CheckIn.Entities.CheckInSessionToken", "Token")
            ...
            modelBuilder.Entity("WitchCityRope.Api.Features.Cms.Entities.ContentPage", b =>
                {
                    ...
                    b.HasOne("WitchCityRope.Api.Models.ApplicationUser", "DeletedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("WitchCityRope.Api.Features.Participation.Entities.AuthorizedContact", b =>
                {
                    b.HasOne("WitchCityRope.Api.Models.ApplicationUser", "Delegate")
                        .WithMany()
                        .HasForeignKey("DelegateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WitchCityRope.Api.Models.ApplicationUser", "Principal")
                        .WithMany()
            ...
            modelBuilder.Entity("WitchCityRope.Api.Features.Participation.Entities.EventAttendance", b =>
                {
                    b.HasOne("WitchCityRope.Api.Models.ApplicationUser", "AssignedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("WitchCityRope.Api.Models.TicketPurchase", b =>
                {
                    b.HasOne("WitchCityRope.Api.Models.ApplicationUser", "PurchasedForUser")
                        .WithMany()
                        .HasForeignKey("PurchasedForUserId")
                        .OnDelete(DeleteBehavior.SetNull);
