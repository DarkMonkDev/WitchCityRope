    ...
    private async Task SeedVettingTemplatesAsync(Guid adminUserId, CancellationToken cancellationToken)
    {
        ...
        var templates = new[]
        {
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{scene_name}}", "{{application_number}}", "{{custom_message}}", "{{submission_date}}", "{{application_date}}", "{{status_change_date}}", "{{current_status}}" }),
                IsActive = true,
                Version = 1,
                CreatedAt = DateTime.UtcNow,
                UpdatedAt = DateTime.UtcNow,
    ...
    private async Task SeedEventsTemplatesAsync(Guid adminUserId, CancellationToken cancellationToken)
    {
        ...
        var templates = new[]
        {
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_date}}", "{{session_time}}", "{{event_date}}", "{{event_time}}", "{{venue_name}}", "{{venue_address}}", "{{ticket_type}}", "{{total_paid}}", "{{confirmation_number}}", "{{ticket_sessions_list}}", "{{ticket_sessions_list_text}}", "{{event_details_url}}", "{{event_details_button}}" }),
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_name}}", "{{session_date}}", "{{session_time}}", "{{event_date}}", "{{event_time}}", "{{venue_name}}", "{{venue_address}}", "{{event_details_url}}", "{{event_details_button}}" }),
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_name}}", "{{session_date}}", "{{session_time}}", "{{event_date}}", "{{event_time}}", "{{venue_name}}", "{{event_details_url}}", "{{event_details_button}}" }),
                TriggerType = TemplateTriggerType.TimeBased,
                TimingOffsetDays = 0,
                TimingOffsetHours = 2,
                RecipientGroup = EventRecipientGroup.RSVPTicketHolders,
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_date}}", "{{event_date}}", "{{custom_message}}", "{{cancelled_sessions_list}}", "{{cancelled_sessions_list_text}}", "{{event_details_url}}", "{{event_details_button}}" }),
                TriggerType = TemplateTriggerType.FixedEvent,
                RecipientGroup = EventRecipientGroup.RSVPTicketHolders,
                IsActive = true,
                Version = 1,
            ...
            new GlobalEmailTemplate
            {
                ...
                HtmlBody = "<p>Hi {{attendee_name}},</p><p>You're all set! Your RSVP for <strong>{{event_title}}</strong> has been confirmed.</p><p><strong>Event Details:</strong><br>Date: {{session_date}}<br>Time: {{session_time}}<br>Venue: {{venue_name}}<br>Address: {{venue_address}}</p><p>We look forward to seeing you there!</p><p>Questions? Email events@witchcityrope.com</p>",
                PlainTextBody = "Hi {{attendee_name}},\n\nYou're all set! Your RSVP for {{event_title}} has been confirmed.\n\nEvent Details:\nDate: {{session_date}}\nTime: {{session_time}}\nVenue: {{venue_name}}\nAddress: {{venue_address}}\n\nWe look forward to seeing you there!\n\nQuestions? Email events@witchcityrope.com",
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_date}}", "{{session_time}}", "{{event_date}}", "{{event_time}}", "{{venue_name}}", "{{venue_address}}", "{{event_details_url}}", "{{event_details_button}}" }),
                TriggerType = TemplateTriggerType.FixedEvent,
                RecipientGroup = EventRecipientGroup.RSVPTicketHolders,
                IsActive = true,
                Version = 1,
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_date}}", "{{session_time}}", "{{event_date}}", "{{event_time}}", "{{venue_name}}", "{{venue_address}}", "{{custom_message}}", "{{event_details_url}}", "{{event_details_button}}" }),
                TriggerType = TemplateTriggerType.FixedEvent,
                RecipientGroup = EventRecipientGroup.RSVPTicketHolders,
                IsActive = true,
                Version = 1,
            ...
            new GlobalEmailTemplate
            {
                ...
                HtmlBody = "<p>Hi {{attendee_name}},</p><p>There has been an update to the session <strong>{{session_name}}</strong> for <strong>{{event_title}}</strong>.</p><p><strong>New Date/Time:</strong> {{session_date}} at {{session_time}}</p><p>{{custom_message}}</p><p>Thank you for your understanding.</p>",
                PlainTextBody = "Hi {{attendee_name}},\n\nThere has been an update to the session {{session_name}} for {{event_title}}.\n\nNew Date/Time: {{session_date}} at {{session_time}}\n\n{{custom_message}}\n\nThank you for your understanding.",
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_name}}", "{{session_date}}", "{{session_time}}", "{{event_date}}", "{{event_time}}", "{{custom_message}}", "{{event_details_url}}", "{{event_details_button}}" }),
                TriggerType = TemplateTriggerType.FixedEvent,
                RecipientGroup = EventRecipientGroup.RSVPTicketHolders,
                IsActive = true,
                Version = 1,
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_name}}", "{{session_date}}", "{{event_date}}", "{{event_details_url}}", "{{event_details_button}}" }),
                TriggerType = TemplateTriggerType.TimeBased,
                TimingOffsetDays = -1,
                RecipientGroup = EventRecipientGroup.RSVPTicketHolders,
                IsActive = true,
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{volunteer_name}}", "{{event_title}}", "{{session_name}}", "{{session_date}}", "{{session_time}}", "{{event_date}}", "{{event_time}}", "{{volunteer_role}}", "{{shift_start}}", "{{shift_end}}", "{{venue_name}}", "{{venue_address}}", "{{event_details_url}}", "{{event_details_button}}" }),
                TriggerType = TemplateTriggerType.TimeBased,
                TimingOffsetDays = 2,
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{volunteer_name}}", "{{event_title}}", "{{session_name}}", "{{session_date}}", "{{event_date}}", "{{volunteer_role}}", "{{event_details_url}}", "{{event_details_button}}" }),
                TriggerType = TemplateTriggerType.TimeBased,
                TimingOffsetDays = -1,
                RecipientGroup = EventRecipientGroup.SessionVolunteers,
                IsActive = true,
