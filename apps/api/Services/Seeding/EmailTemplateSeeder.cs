    ...
    private async Task SeedEventsTemplatesAsync(Guid adminUserId, CancellationToken cancellationToken)
    {
        ...
        var templates = new[]
        {
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_date}}", "{{session_time}}", "{{venue_name}}", "{{venue_address}}", "{{ticket_type}}", "{{total_paid}}", "{{confirmation_number}}", "{{ticket_sessions_list}}", "{{ticket_sessions_list_text}}" }),
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_name}}", "{{session_date}}", "{{session_time}}", "{{venue_name}}", "{{venue_address}}" }),
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_name}}", "{{session_time}}", "{{venue_name}}" }),
                TriggerType = TemplateTriggerType.TimeBased,
                TimingOffsetDays = 0,
                TimingOffsetHours = 2,
                RecipientGroup = EventRecipientGroup.RSVPTicketHolders,
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_date}}", "{{custom_message}}", "{{cancelled_sessions_list}}", "{{cancelled_sessions_list_text}}" }),
                TriggerType = TemplateTriggerType.FixedEvent,
                RecipientGroup = EventRecipientGroup.RSVPTicketHolders,
                IsActive = true,
                Version = 1,
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_date}}", "{{session_time}}", "{{venue_name}}", "{{venue_address}}" }),
                TriggerType = TemplateTriggerType.FixedEvent,
                RecipientGroup = EventRecipientGroup.RSVPTicketHolders,
                IsActive = true,
                Version = 1,
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_date}}", "{{session_time}}", "{{venue_name}}", "{{venue_address}}", "{{custom_message}}" }),
                TriggerType = TemplateTriggerType.FixedEvent,
                RecipientGroup = EventRecipientGroup.RSVPTicketHolders,
                IsActive = true,
                Version = 1,
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_name}}", "{{session_date}}", "{{session_time}}", "{{custom_message}}" }),
                TriggerType = TemplateTriggerType.FixedEvent,
                RecipientGroup = EventRecipientGroup.RSVPTicketHolders,
                IsActive = true,
                Version = 1,
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{attendee_name}}", "{{event_title}}", "{{session_name}}", "{{session_date}}" }),
                TriggerType = TemplateTriggerType.TimeBased,
                TimingOffsetDays = -1,
                RecipientGroup = EventRecipientGroup.RSVPTicketHolders,
                IsActive = true,
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{volunteer_name}}", "{{event_title}}", "{{session_name}}", "{{session_date}}", "{{session_time}}", "{{volunteer_role}}", "{{shift_start}}", "{{shift_end}}", "{{venue_name}}", "{{venue_address}}" }),
                TriggerType = TemplateTriggerType.TimeBased,
                TimingOffsetDays = 2,
            ...
            new GlobalEmailTemplate
            {
                ...
                Variables = JsonSerializer.Serialize(new[] { "{{volunteer_name}}", "{{event_title}}", "{{session_name}}", "{{session_date}}", "{{volunteer_role}}" }),
                TriggerType = TemplateTriggerType.TimeBased,
                TimingOffsetDays = -1,
                RecipientGroup = EventRecipientGroup.SessionVolunteers,
                IsActive = true,
