      ...
      >
        ...
        {(() => {
          ...
          if (sessions.length === 1) {
            ...
            const isPast = session.endTime ? new Date(session.endTime) < new Date() : false
            return (
              <Stack
                gap={2}
              ...
              >
                ...
                <Group justify="space-between">
                  ...
                  >
                    {isPast ? 'Completed' : formatUtcTimeRange(session.startTime || '', session.endTime || '', eventTimeZone)
                      .toLowerCase()}
                  </Text>
                </Group>
              </Stack>
