...
import { VettingApplicationDetail } from '../VettingApplicationDetail'
...
// Mock the hooks
vi.mock('../../hooks/useVettingApplicationDetail')
vi.mock('../../hooks/useSubmitReviewDecision')
vi.mock('../../hooks/useApproveApplication')
