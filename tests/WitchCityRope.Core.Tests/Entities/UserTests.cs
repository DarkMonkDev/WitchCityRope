...
namespace WitchCityRope.Core.Tests.Entities
{
    public class UserTests
    {
        ...
        public void Constructor_ValidData_CreatesUser()
        {
            ...
            // Act
            var user = new User(encryptedLegalName, sceneName, email, dateOfBirth, role);
        ...
        {
            // Arrange
            var user = new UserBuilder().WithAge(25).Build();
        ...
        {
            // Arrange
            var user = new UserBuilder().WithRole(currentRole).Build();
