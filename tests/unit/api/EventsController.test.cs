...
using Moq;
using WitchCityRope.Api.Controllers;
...
/// <summary>
/// Unit tests for EventsController - Vertical Slice Home Page Implementation
/// Tests the API layer of React + API + PostgreSQL stack
/// </summary>
