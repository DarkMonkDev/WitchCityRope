...
vi.mock('../../../apps/web/src/components/LoadingSpinner', () => ({
...
describe('EventsList Component - Vertical Slice Home Page Tests', () => {
  ...
  it('displays error message when API call fails', async () => {
    ...
    expect(screen.getByText(/API service is running on http:\/\/localhost:5655/)).toBeInTheDocument();
  });
  ...
  it('proves React + API stack integration works', async () => {
    ...
    expect(eventsGrid).toHaveClass('grid', 'grid-cols-1', 'md:grid-cols-2', 'lg:grid-cols-3', 'gap-6');
  });
