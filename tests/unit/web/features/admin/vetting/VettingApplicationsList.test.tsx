...
import { useVettingApplications } from '@/features/admin/vetting/hooks/useVettingApplications';
import type { ApplicationSummaryDto } from '@/features/admin/vetting/types/vetting.types';

// Mock the hooks
vi.mock('@/features/admin/vetting/hooks/useVettingApplications');
