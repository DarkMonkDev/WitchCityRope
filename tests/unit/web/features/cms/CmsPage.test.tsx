...
import * as authStore from '@/features/cms/../../stores/authStore'
import * as useCmsPageHook from '@/features/cms/hooks/useCmsPage'

// Mock dependencies
vi.mock('@/stores/authStore')
vi.mock('@/features/cms/hooks/useCmsPage')
