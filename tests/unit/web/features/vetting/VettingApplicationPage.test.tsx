...
// Mock dependencies
vi.mock('@/features/vetting/hooks/useVettingStatus', () => ({
  useVettingStatus: vi.fn()
}));

vi.mock('@/features/vetting/components/VettingApplicationForm', () => ({
  VettingApplicationForm: vi.fn(() => <div data-testid="vetting-form">Form Component</div>)
}));

vi.mock('@/features/vetting/components/VettingStatusBox', () => ({
