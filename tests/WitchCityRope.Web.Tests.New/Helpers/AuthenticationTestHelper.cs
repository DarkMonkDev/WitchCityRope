...
public static class AuthenticationTestHelper
{
        ...
        UserDto? currentUser = null)
    {
        ...
        if (currentUser != null)
        {
            mock.Setup(x => x.IsInRole(It.IsAny<string>()))
                .Returns((string role) => currentUser.Roles?.Contains(role) ?? false);
        }
    ...
    /// <summary>
    /// Creates a UserInfo object for testing
    /// </summary>
