...
/// </summary>
public class PaymentWorkflowIntegrationTests : IDisposable
{
    ...
    public PaymentWorkflowIntegrationTests()
    {
    ...
    public async Task TicketPurchaseWorkflow_FromPaymentToCompletion_SucceedsEndToEnd()
    {
        ...
        auditLogs.Should().Contain(a => a.EventType == "PaymentInitiated");
        auditLogs.Should().Contain(a => a.EventType == "PaymentCompleted");
    }
    ...
    public async Task RefundWorkflow_FromRequestToCompletion_SucceedsEndToEnd()
    {
        ...
        // Act - Step 2: Verify payment status updated
        ...
        auditLogs.Should().Contain(a => a.EventType == "RefundInitiated");
        auditLogs.Should().Contain(a => a.EventType == "RefundCompleted");
    }
    ...
    public async Task ConcurrentPaymentWorkflow_PreventsDoubleBooking()
    {
        ...
        // At least one payment should be completed
    ...
    private void SetupSuccessfulPayPalRefund()
    {
        ...
        var paypalRefundResponse = new PayPalRefundResponse
        {
            ...
            Amount = Money.Create(75.00m, "USD")
        };
