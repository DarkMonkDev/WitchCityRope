...
1. **Event Types**: Classes, Workshops, Performances, Social Events
...
4. **Pricing**: Sliding scale supported, payment at door options
...
3. Sets sliding scale pricing $25-45, 48-hour refund window
4. Event goes live, members can register
5. Organizer manages waitlist as event fills up
6. Day of event: processes payments at door (cash and digital)
7. Post-event: reviews attendance and financial reports
