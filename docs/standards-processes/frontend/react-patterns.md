...
**Purpose**: Standardized React component patterns, hooks usage, and best practices for WitchCityRope.
**When to Read**: When implementing React components, hooks, or debugging component behavior.
